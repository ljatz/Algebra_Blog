                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
						@if(Sentinel::check())
							...
							<li class="{{ Request::is('posts*') ? 'active' : '' }}"><a href="{{ route('posts.index') }}">Posts <span class="badge">{{ Post::countPosts() }}</span></a></li>
						@endif
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        @else
                            <li class="{{ Request::is('login') ? 'active' : '' }}"><a href="{{ route('auth.login.form') }}">Login</a></li>
                            <li class="{{ Request::is('register') ? 'active' : '' }}"><a href="{{ route('auth.register.form') }}">Register</a></li>
                        @endif
                    </ul>
                </div><!-- /.navbar-collapse -->
            </div><!-- /.container-fluid -->
